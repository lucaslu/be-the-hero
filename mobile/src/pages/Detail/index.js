...
export default function Detail() {
    ...
    const message = `Hi ${incident.name}, I would like to help in the incident ${incident.title}`
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.incident}>
                ...
                <Text style={styles.incidentValue}>{incident.name} of {incident.city}/{incident.st}</Text>
